...
ggsave("../graphs/fig2.pdf", width = 12, height = 3, scale = 1.25, bg = "white")
```
...
ggsave("../graphs/fig3.pdf", height = 3.5, width = 12, scale = 1.25, bg = "white")
```
...
ggsave("../graphs/fig4.pdf", height = 5, width = 10, scale = 1.25, bg = "white")
```
