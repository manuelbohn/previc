...
Figure \@ref(fig:figs1) shows the distribution of estimation errors when comparing our maximum likelihood estimation implementation with `catR`. Differences between the two procedures are extremely small, all below 0.001. 
